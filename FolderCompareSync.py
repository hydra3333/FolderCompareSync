...
# ============================================================================
# LOGGING SETUP (MUST BE BEFORE FileTimestampManager_class)
...
#=== START OF Common FileTimestampManager_class Code ==============================================================================================================
...
#=== END OF Common FileTimestampManager_class Code ==============================================================================================================
            ...
            for i, rel_path in enumerate(selected_paths):
                try:
                    ...
                    if Path(source_path).exists() and Path(source_path).is_file():
                        ...
                        if strategy == FileCopyManager_class.CopyStrategy.STAGED and file_size >= COPY_STRATEGY_THRESHOLD:
