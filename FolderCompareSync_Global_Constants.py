...
# >>> CHANGE START
# MIGRATION NOTE:
# Legacy FILECOPY_* alias constants were removed.
# Use real pywin32 names at callsites instead, e.g.:
#   win32con.FILE_ATTRIBUTE_SPARSE_FILE
#   win32con.FILE_FLAG_BACKUP_SEMANTICS
#   win32file.COPY_FILE_RESTARTABLE
#   winerror.ERROR_ACCESS_DENIED
#   winioctlcon.FSCTL_SET_COMPRESSION
# Progress/Callback numeric codes (if used) should be referenced directly where needed.
# <<< CHANGE END
