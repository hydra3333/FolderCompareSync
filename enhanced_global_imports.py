...
# ============================================================================
# ENHANCED FILE COPY SYSTEM IMPORTS (M14, M15)
# ============================================================================

# BLAKE3 hashing support with fallback
try:
    import blake3
    BLAKE3_AVAILABLE = True
except ImportError:
    BLAKE3_AVAILABLE = False
    # Will use SHA-256 fallback from hashlib
...
_OPTIONAL_INSTALL_HINTS = {
    ...
    "tkinter": (
        "Tk/tkinter isnâ€™t usually installed via pip.\n"
...
def _check_dependencies(deps: list[tuple[str, str]]) -> None:
    ...
    """
    missing_pip: list[str] = []                      # ones weâ€™ll suggest 'pip install' for
...
def check_and_import_core_deps() -> None:
    ...
    # *** Passed checking
    # Now do NORMAL imports (not "ensure_*" calls). These then auto become part of this moduleâ€™s globals:
    import zoneinfo
...
def _auto_build_all() -> list[str]:
    """
    Export everything newly introduced by this moduleâ€™s imports,
...
#
# Remember:
# - Later additions update THIS moduleâ€™s globals and __all__ but not for any other modules
